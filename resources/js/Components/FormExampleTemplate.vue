        ...
        <v-container>
            ...
            <v-row>
                <v-col cols="12" md="6">
                    ...
                    <v-file-input id="fileInput" variant="outlined" v-model="data.files" prepend-icon=""
                        append-inner-icon="mdi-paperclip" multiple
                        @change="() => console.log(data.files)"></v-file-input>
                </v-col>
